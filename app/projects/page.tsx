  ...
  return (
    <div className="max-w-screen-xl mx-auto px-[2rem] relative py-[4rem]">
      <div className="flex flex-row items-center gap-[23px] pt-[88px]">
        <h1 className="text-[#fff] font-tinyBrushy text-[48px] font-normal uppercase ">
          MY PROJECTS
        </h1>
        <Image
          src={productdesign}
      ...
      <Image
        ...
        height={4}
      />
      <p className="text-[#C9CFD9] font-Beginning text-[20px] font-normal leading-[32px] ">
      ...
      <div>
        <h1 className="text-[#fff] pt-[90px] text-center  font-tinyBrushy text-[32px] font-normal uppercase leading-[normal] ">
          CASE STUDIES.
        </h1>
          ...
          <div
            ...
            className={`cursor-pointer ${
              tab === "design-projects"
                ...
                : "text-[#C9CFD9]"
            } py-2  px-5  text-base font-normal font-Beginning leading-[normal]`}
          >
            Design Projects
          </div>
          <div
