...
const AskAiChat = () => {
  ...
  return (
    <div className="mx-auto flex max-w-screen-xl flex-col gap-10 px-5 pb-16 pt-[112px] md:px-8 lg:px-[112px]">
      {hasConversation ? (
        <>
          <div className="mx-auto flex w-full max-w-[988px] justify-end">
            <button
              type="button"
              onClick={() => setShowClearDialog(true)}
              disabled={isLoading}
              className="inline-flex items-center gap-2 rounded-full border border-base px-4 py-2 text-fig-14 text-label hover:bg-surface-2 hover:text-title disabled:cursor-not-allowed disabled:opacity-40"
