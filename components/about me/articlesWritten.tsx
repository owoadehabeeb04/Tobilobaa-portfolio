              ...
              >
                <div className="flex flex-row gap-5 items-center">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <p className="text-[#C9CFD9] font-Beginning text-sm leading-[normal] font-normal ">
                      {article?.minRead} {dots} {article?.date}
                    </p>
               
                    <Link className="text-[#FFA17A] text-base font-normal leading-[normal] font-Beginning " href={article?.link}> {article?.linkTitle} <ArrowUpRight size={14} color="#"/> </Link>{" FFA17A"}
                  </div>
                </div>
              </div>
            ))}
